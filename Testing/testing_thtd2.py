...
anomaly_threshVal0_param = 1.5
anomaly_threshVal1_param = 1.5
...
def train(outlier_fraction1, outlier_fraction2):
    ...
    filename_hum_model = var1 + 'testing2' + var_hum
    filename_temp_model = var1 + 'testing2' + var_temp
...
while i<len(data_temp1):
    try:
        ...
        print(data_temp1[i])
        print('thtd2/anomaly_score_temp:' + str(anomaly_score_temp))
        print('thtd2/anomaly_threshold_temp:' + str(anomaly_threshVal0))
        print('thtd2/anomaly_status_temp:' + sensor_temp_status)
        print(data_hum1[i])
        print('thtd2/anomaly_score_hum:' + str(anomaly_score_hum))
        print('thtd2/anomaly_threshold_hum:' + str(anomaly_threshVal1))
        print('thtd2/anomaly_status_hum:' + sensor_hum_status)

        #print(time.time()-t2)
        time.sleep(0.5)
    except:
        np.savetxt("thtd2/result_data_temp1.csv", arr_data_temp1, delimiter=",", fmt="%.1f")
        np.savetxt("thtd2/result_anomaly_score_temp1.csv", arr_score_temp1, delimiter=",", fmt="%.3f")
        np.savetxt("thtd2/result_anomaly_threshold_temp1.csv", arr_threshold_temp1, delimiter=",", fmt="%.3f")
        arr_status_temp1.tofile('thtd2/result_anomaly_status_temp1.csv', sep='\n')

        np.savetxt("thtd2/result_data_hum1.csv", arr_data_hum1, delimiter=",", fmt="%.1f")
        np.savetxt("thtd2/result_anomaly_score_hum1.csv", arr_score_hum1, delimiter=",", fmt="%.3f")
        np.savetxt("thtd2/result_anomaly_threshold_hum1.csv", arr_threshold_hum1, delimiter=",", fmt="%.3f")
        arr_status_hum1.tofile('thtd2/result_anomaly_status_hum1.csv', sep='\n')
        time.sleep(1)
        print('except')
    finally:
        i += 1

np.savetxt("result_data_temp1.csv", arr_data_temp1, delimiter=",", fmt="%.1f")
np.savetxt("result_anomaly_score_temp1.csv", arr_score_temp1, delimiter=",", fmt="%.3f")
np.savetxt("result_anomaly_threshold_temp1.csv", arr_threshold_temp1, delimiter=",", fmt="%.3f")
arr_status_temp1.tofile('result_anomaly_status_temp1.csv', sep='\n')

np.savetxt("result_data_hum1.csv", arr_data_hum1, delimiter=",", fmt="%.1f")
np.savetxt("result_anomaly_score_hum1.csv", arr_score_hum1, delimiter=",", fmt="%.3f")
np.savetxt("result_anomaly_threshold_hum1.csv", arr_threshold_hum1, delimiter=",", fmt="%.3f")
arr_status_hum1.tofile('result_anomaly_status_hum1.csv', sep='\n')
print('finish')