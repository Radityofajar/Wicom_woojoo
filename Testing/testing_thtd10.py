...
anomaly_threshVal0_param = 3.3
anomaly_threshVal1_param = 3.3
...
def train(outlier_fraction1, outlier_fraction2):
    ...
    filename_hum_model = var1 + 'testing10' + var_hum
    filename_temp_model = var1 + 'testing10' + var_temp
...
while i<len(data_temp1):
    try:
        ...
        np.savetxt("thtd10/result_data_temp1.csv", arr_data_temp1, delimiter=",", fmt="%.1f")
        np.savetxt("thtd10/result_anomaly_score_temp1.csv", arr_score_temp1, delimiter=",", fmt="%.3f")
        np.savetxt("thtd10/result_anomaly_threshold_temp1.csv", arr_threshold_temp1, delimiter=",", fmt="%.3f")
        arr_status_temp1.tofile('thtd10/result_anomaly_status_temp1.csv', sep='\n')

        np.savetxt("thtd10/result_data_hum1.csv", arr_data_hum1, delimiter=",", fmt="%.1f")
        np.savetxt("thtd10/result_anomaly_score_hum1.csv", arr_score_hum1, delimiter=",", fmt="%.3f")
        np.savetxt("thtd10/result_anomaly_threshold_hum1.csv", arr_threshold_hum1, delimiter=",", fmt="%.3f")
        arr_status_hum1.tofile('thtd10/result_anomaly_status_hum1.csv', sep='\n')
        time.sleep(1)
        print('except')
    finally:
        i += 1
